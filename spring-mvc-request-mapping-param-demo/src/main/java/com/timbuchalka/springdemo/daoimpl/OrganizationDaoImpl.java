...
public class OrganizationDaoImpl implements OrganizationDao {
	...
	public boolean create(Organization org) {
		...
		String sqlQuery = "INSERT INTO organization (comapny_name, year_of_incorporation, postal_code, employee_count, slogan) "
...
//		return jdbcTemplate.update(sqlQuery, args) == 1;
	...
	public Organization getOrganization(Integer id) {
		...
		String sqlQuery = "SELECT id, comapny_name, year_of_incorporation, postal_code, employee_count, slogan "
