...
public class DaoUtils {
	...
	public static void printSuccessFaiure(String operation, boolean param){
		if(param){
	...
	public static void createSeedData(OrganizationDao dao){
		Organization org1 = new Organization("Amazon", 1994, "65656", 8765, "Work hard, have fun, make a history");
